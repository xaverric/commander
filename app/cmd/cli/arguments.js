...
const cmdArgumentsDefinition = [
  ...
  },
  {
    ...
    alias: 'd',
    type: String,
    description: `Path specifying location data file with list of dtoIn. The file needs to be written according to the following convention. Each dtoIn inside the itemList array must meet the criteria of the dtoIn for the uri to be called. 
